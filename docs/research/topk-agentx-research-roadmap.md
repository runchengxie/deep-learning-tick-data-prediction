...
- M3 v1 在完成 14/60 个月后停止。2021 年 1 月 4 日至 6 月 4 日的委托源没有沪市股票，1 月至 5 月约有 48% 至 50% 的候选缺少全部三模态特征。M3 v2 从 2021 年 7 月开始重新物化 54 个月，正式预测和 Top-K 成本诊断要在 v2 完整物化后运行。
...
1. 使用 M3 v2 从 2021 年 7 月开始物化全部 54 个月，汇总逐月耗时、峰值内存、缺失特征比例和全量数据指纹。v1 保留为审计记录。不得因缺分钟行缩小每日 Top-400。
